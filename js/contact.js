...
const init = function () {
    ...
    //write the contests on the screen
    updateList();
    ...
    document.querySelector('ul.contacts').addEventListener('click', editForm);
...
const addContact = function (ev) {
    ...
    // reaplace localStorage with new contact array
    ev.preventDefault();
    let obj = {};
    ...
    if (fullname && email && phone) {
        ...
        //TODO: check for duplicates in the contacts array...
        contacts.push(obj);
...
const removeContact = function (ev) {
    //get the data-key
    //find the matching email adress in global contacts
    //remove that obj  from the contacts array
    //update localstorage with new contacts array
